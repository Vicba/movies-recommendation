...
//   return (
//     <div className="relative h-[256px] w-[384px] overflow-hidden rounded-lg">
//       <div className="relative h-full w-full transition-transform duration-300 transform hover:scale-110">
//         <img
